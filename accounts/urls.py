...
urlpatterns = [
    ...
    path('consultants/<int:consultant_id>/reviews/', views.view_reviews, name='view_reviews'),
    path('consultants/<int:consultant_id>/reviews/submit/', views.submit_review, name='submit_review'),
